...
#define NODE_MAIN_LOGGER_NAME "test_grab_image_action_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libaction_client_test_grab_images.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pylon_ros2_camera::TestGrabImagesActionClient>";
