...
#include "pylon_ros2_camera_interfaces/srv/detail/set_exposure__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pylon_ros2_camera_interfaces::srv::SetExposure_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pylon_ros2_camera_interfaces::srv::SetExposure_Request & ros_message)
{
  // Member: target_exposure
  cdr >> ros_message.target_exposure;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pylon_ros2_camera_interfaces::srv::SetExposure_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pylon_ros2_camera_interfaces::srv::SetExposure_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pylon_ros2_camera_interfaces::srv::SetExposure_Request *>(
    untyped_ros_message);
...
{
  return &pylon_ros2_camera_interfaces::srv::typesupport_fastrtps_cpp::_SetExposure_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pylon_ros2_camera_interfaces, srv, SetExposure_Request)() {
  return &pylon_ros2_camera_interfaces::srv::typesupport_fastrtps_cpp::_SetExposure_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pylon_ros2_camera_interfaces
cdr_serialize(
  const pylon_ros2_camera_interfaces::srv::SetExposure_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pylon_ros2_camera_interfaces::srv::SetExposure_Response & ros_message)
{
  // Member: reached_exposure
  cdr >> ros_message.reached_exposure;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pylon_ros2_camera_interfaces::srv::SetExposure_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pylon_ros2_camera_interfaces::srv::SetExposure_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pylon_ros2_camera_interfaces::srv::SetExposure_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pylon_ros2_camera_interfaces::srv::typesupport_fastrtps_cpp::_SetExposure_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pylon_ros2_camera_interfaces, srv, SetExposure_Response)() {
  return &pylon_ros2_camera_interfaces::srv::typesupport_fastrtps_cpp::_SetExposure_Response__handle;
}
...
{
  return &pylon_ros2_camera_interfaces::srv::typesupport_fastrtps_cpp::_SetExposure__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pylon_ros2_camera_interfaces, srv, SetExposure)() {
  return &pylon_ros2_camera_interfaces::srv::typesupport_fastrtps_cpp::_SetExposure__handle;
}
